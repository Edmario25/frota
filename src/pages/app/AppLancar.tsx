...
function FormBorracharia({ vehicleId, employeeId, onClose }: { vehicleId: string; employeeId: string; onClose: () => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <MobilePhotoCapture
        label="Foto dos pneus / comprovante (opcional)"
        bucket="tire-photos"
        vehicleId={vehicleId}
        value={fotoUrl}
        onChange={setFotoUrl}
...
function FormMulta({ vehicleId, employeeId, onClose }: { vehicleId: string; employeeId: string; onClose: () => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <MobilePhotoCapture
        label="Foto da notificação / comprovante (opcional)"
        bucket="fine-photos"
        vehicleId={vehicleId}
        value={fotoUrl}
        onChange={setFotoUrl}
